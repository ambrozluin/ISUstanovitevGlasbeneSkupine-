                    ...
                    @unless($invites->isEmpty())
                        @auth
                            @foreach($invites as $invite)
                                @if (Auth::user()->email == $invite->email) <!-- restrict and show only messegaes sended to me -->
                                    @if ( !Auth::user()->isMyGroup($invite->group) )
                                        <tr>
                                            ...
                                            <td scope="row">
                                                <a href="" class="btn btn-warning"> Sprejmi</a>
                                            </td>
                                        </tr>
                                    @endif
                                @else
                                    <tr>
                                        <td scope="row">Nabiralnik je prazen</td>
                                        <td scope="row"></td>
                                        <td scope="row"></td>
                                        <td scope="row"></td>
                                        <td scope="row"></td>
